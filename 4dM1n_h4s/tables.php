...
<body class="hold-transition sidebar-mini layout-navbar-fixed">
    ...
    <div class="page-loader-wrapper">
        ...
        <div class="card-body p-0">
            <div class="download">
              <a class="btn btn-primary btn-sm" href="./daftar">
            ...
            while($row = mysqli_fetch_assoc($result)){
                $id = $row['cp_id'];
                $cp =  mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT nama FROM cp WHERE id=$id"));
                echo "<tr>";
                ...
                echo '<td><a id="hapus" class="btn btn-danger btn-sm" href=delete?nim='.$row["nim"].'><i class="fa fa-trash"></i>Hapus</a></td>';
