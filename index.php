...
<body>
                ...
                <div class="col-9">
                    <div id="social">
                        <ul>
                            ...
                            <li><a href="http://github.com/fosti"><i class="icon-github"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<div class="row">
				<div class="col-lg-5">
					<div id="left_form">
						...
						<a href="https://bit.ly/HaloFosti2020" target="_blank" id="more_info" ><i class="pe-7s-info"></i></a>
					</div>
				</div>
				<div class="col-lg-7">
							...
							<div id="middle-wizard">
								...
								<div class="submit step">
									...
									<div class="form-group terms">
										<div class="g-recaptcha" data-sitekey="6LdPzFQUAAAAAE46xIUneyoQ_m6n-rutMD8q5Tc5"></div> <!--oprec.fostiums.org-->
										<!-- <div class="g-recaptcha" data-sitekey="6LdE38AZAAAAALJWbWhSiYE6lO-vgV8UJZO1wxMS"></div> --> <!--127.0.0.1-->
										<br>
	...
	<footer id="home" class="clearfix">
		...
		<ul>
			...
			<li><a href="https://bit.ly/HaloFosti2020" target="_blank" class="animated_link">Bantuan</a></li>
		</ul>
	</footer>
	<!-- end footer-->
