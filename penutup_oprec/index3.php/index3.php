...
<body>
	...
	<header>
		<div class="container-fluid">
		    <div class="row">
                <div class="col-3">
                    <div id="logo_home">
                        <h1><a href="./">Pendaftaran OPREC | Forum Open Source Teknik Informatika</a></h1>
                    </div>
                </div>
                <div class="col-9">
                    <div id="social">
                        <ul>
                            <li><a href="https://www.facebook.com/Fosti.Umsurakarta/"><i class="icon-facebook"></i></a></li>
                            <li><a href="https://twitter.com/fostiums?lang=en"><i class="icon-twitter"></i></a></li>
			...
			<div class="row">
				<div class="col-lg-5">
					<div id="left_form">
						...
						<h2>Pendaftaran</h2> 
						<p>Form pendaftaran OPREC FOSTI atau Forum Open Source Teknik Informatika, Silahkan isi data anda dengan benar dan tepat. Apabila ada kekeliruan atau masalah silahkan tekan tombol Bantuan dibawah.</p>
						<a href="http://www.bit.ly/haloFOSTI" target="_blank" id="more_info" ><i class="pe-7s-info"></i></a>
					</div>
				</div>
				<div class="col-lg-7">
							...
							<div id="middle-wizard">
								...
								<div class="step">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-group">
											<input type="file" name="foto_pribadi" class="custom-file-input" id="customFile">
										...
										<div class="col-md-6">
										    <label>Ukuran file max 2 MB</label>
											<div class="form-group">
											<input type="file" name="foto_ktm" class="custom-file-input"id="customFile">
								...
								<!--<div class="submit step">
									...
									<div class="form-group terms">
										<div class="g-recaptcha" data-sitekey="6LdPzFQUAAAAAE46xIUneyoQ_m6n-rutMD8q5Tc5"></div>
										<br>
										<input name="terms" type="checkbox" class="icheck required" value="yes">
										<label>Setuju dengan <a href="#" data-toggle="modal" data-target="#terms-txt">Syarat dan Ketentuan</a> ?</label><br>
	...
	<footer id="home" class="clearfix">
		<p>© 2019 FOSTI</p>
		<ul>
			<li><a href="http://fosti.ums.ac.id" class="animated_link">Fourm Open Source Teknik Informatika</a></li>

			<li><a href="http://www.bit.ly/haloFOSTI" target="_blank" class="animated_link">Bantuan</a></li>
		</ul>
	</footer>
	<!-- end footer-->
